        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <h1
              ...
              Scale-Up Brand Anda Bersama{' '}
              <span className="text-accent">Arief</span>
              {'. '}Jadikan{' '}
              <span className="text-accent">Data</span>
              {' '}Sebagai Arah{' '}
              <span className="text-accent">Pertumbuhan Nyata</span>
              {'.'}
            </h1>
            ...
            <p
              ...
              Berpengalaman sebagai Performance Marketer yang telah dipercaya lebih dari 20 brand sebagai growth partner. Berfokus pada TikTok Ads, Shopee Ads, CPAS, dan Meta Ads, saya tidak sekadar mengelola dan mengoptimasi iklan, tetapi juga memberikan insight bisnis up-to-date melalui komunikasi dua arah yang intens dan transparansi data sepenuhnya.
            </p>
