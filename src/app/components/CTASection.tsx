    ...
    <section className="relative py-24 bg-foreground overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-5 md:px-8 text-center relative z-10">
        ...
        <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-2 mb-8">
          ...
          <span className="text-xs font-700 text-white/70 tracking-wider uppercase">Slot Terbatas Setiap Bulan</span>
        </div>

        <h2 className="text-section-heading text-white mb-5">
          Mari Bangun
          <br />
          <span className="text-accent">Kolaborasi Strategis.</span>
        </h2>

        <p className="text-base md:text-lg text-white/60 leading-relaxed max-w-2xl mx-auto mb-10">
          Saya memaksimalkan setiap langkah optimasi berdasarkan data nyata demi mencapai skala bisnis yang lebih tinggi secara bertahap.
          <strong className="text-white/90"> Slot terbatas setiap bulannya.</strong>
        </p>
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-6 text-xs text-white/40 font-600 uppercase tracking-wider">
          {['✓ Transparan Data', '✓ Daily Monitoring', '✓ ROI Terukur', '✓ Komunikasi Responsif']?.map((item) => (
